...
int main()
{
    ...
    image_vec[0].add_filter(filters::channel_adjustment(darkness_enhance_1))
                .add_filter(filters::grey_scale())
                .add_filter(filters::gamma_correction(3))
                .add_filter(filters::sepia());

    image_vec[1].add_filter(filters::grey_scale())
                .add_filter(filters::channel_adjustment(darkness_enhance_1))
                .add_filter(filters::negative())
                .add_filter(filters::sepia());

    image_vec[2].add_filter(filters::grey_scale())
                .add_filter(filters::contrast(40))
                .add_filter(filters::channel_adjustment(darkness_enhance_2))
                .add_filter(filters::sepia())
                .add_filter(filters::gamma_correction(3));

    image_vec[3].add_filter(filters::grey_scale())
                .add_filter(filters::sepia())
                .add_filter(filters::gamma_correction(2))
                .add_filter(filters::channel_adjustment(red_channel_enhance));

    image_vec[4].add_filter(filters::negative())
                .add_filter(filters::channel_adjustment(darkness_enhance_2))
                .add_filter(filters::sepia())
                .add_filter(filters::contrast(60));

    image_vec[5].add_filter(filters::sepia())
                .add_filter(filters::gamma_correction(0.5))
                .add_filter(filters::channel_adjustment(brightness_enhance));

    image_vec[6].add_filter(filters::contrast(25))
                .add_filter(filters::channel_adjustment(free_style_enhance))
                .add_filter(filters::grey_scale())
                .add_filter(filters::sepia())
                .add_filter(filters::channel_adjustment(darkness_enhance_2));

    image_vec[7].add_filter(filters::sepia())
                .add_filter(filters::gamma_correction(10))
                .add_filter(filters::contrast(20))
                .add_filter(filters::negative());
    ...
    image_vec[8].add_filter(filters::channel_adjustment(green_channel_enhance))
                ...
                .add_filter(filters::gamma_correction(0.5))
                .add_filter(filters::contrast(25));

    image_vec[9].add_filter(filters::grey_scale())
                .add_filter(filters::contrast(10))
                .add_filter(filters::channel_adjustment(darkness_enhance_2))
                .add_filter(filters::gamma_correction(0.1));
